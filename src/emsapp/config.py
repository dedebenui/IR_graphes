...
class UserData:
    ...
    def __init__(self):
        ...
        try:
            with open(pkg_resources.resource_filename("emsapp", "defaults/user_data.json")) as file:
    ...
    def update(self, value_descr: str, key: str, raw_value: str):
        ...
        with open(
            pkg_resources.resource_filename("emsapp", "defaults/user_data.json"), "w"
        ) as file:
